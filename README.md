...
<table>
  ...
  <tr>
    ...
    <td valign="top">
      AI-powered career copilot for resume improvement, profile review, and smarter job-search decisions.
      <br /><br />
      <strong>Stack:</strong> Next.js, TypeScript, PostgreSQL, Gemini AI, OpenAI APIs
      <br />
      <strong>Link:</strong> <a href="https://github.com/yumebhumi/ResumeAnalyserr">Repository</a>
    </td>
  </tr>
  <tr>
    <td valign="top"><strong>✈️ Rovara</strong></td>
    <td valign="top">
      AI travel planner that generates multi-day itineraries, budgets, recommendations, and shareable trip plans.
      <br /><br />
      <strong>Stack:</strong> Next.js, React, TypeScript, Clerk, Prisma, PostgreSQL, OpenAI
      <br />
      <strong>Link:</strong> <a href="https://github.com/yumebhumi/rovara">Repository</a>
    </td>
  </tr>
  <tr>
    <td valign="top"><strong>🩺 Clinico</strong></td>
    <td valign="top">
      Healthcare platform connecting patients and professionals through a smoother digital experience and AI-assisted support.
      <br /><br />
  ...
  <tr>
    ...
    <td valign="top">
      Women's safety platform with anonymous crime reporting, safety mapping, and community/resource access.
      <br /><br />
      <strong>Stack:</strong> React, Tailwind CSS, Recoil, Leaflet, Node.js, Express, MongoDB
      <br />
      <strong>Link:</strong> <a href="https://stree-project-iota.vercel.app">Live project</a>
    </td>
  </tr>
</table>
